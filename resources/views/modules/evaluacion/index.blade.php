                    ...
                    <div class="col-md-4">
                        <div class="list-group list-group-flush border rounded-4 p-2 bg-light sticky-top" style="top: 80px;">
                            ...
                            @foreach ($items as $i => $doc)
                                <button type="button"
                                    class="list-group-item list-group-item-action border-0 rounded-pill mb-1 documento-btn {{ $i == 0 ? 'active text-white bg-primary' : '' }}"
...
<style>
    .documento-panel { animation: fadeIn 0.4s ease; }
