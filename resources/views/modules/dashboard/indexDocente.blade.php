        ...
        <div class="row">
                        ...
                        <div class="activity">
                            ...
                            <div class="activity-item d-flex">
                                ...
                                <div class="activity-content">
                                    Evidencia aprobada en
                                    <strong>
                                        {{ $actividad->asignacion->materia->nombre ?? 'Materia' }}
                                    </strong>
                                </div>
                                ...
                                <div class="activity-content">
                                    Evidencia pendiente de revisión en
                                    <strong>
                                        {{ $actividad->asignacion->materia->nombre ?? 'Materia' }}
                                    </strong>
                                </div>
            ...
            <div class="col-lg-4">
                <div class="card p-4">
                    ...
                    <a href="{{ route('evidencias') }}" class="btn btn-primary">
