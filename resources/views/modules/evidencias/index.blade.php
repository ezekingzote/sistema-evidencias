                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="text-muted mb-0">
                                    Consulta el estado de evidencias registradas por cada docente y gestiona sus dictámenes.
                                </p>
                            </div>

                            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                <a href="{{ route('evidencias.create') }}" class="btn btn-outline-primary shadow-sm px-4 py-2 rounded-pill fw-bold">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="min-width:160px;">
                                            ...
                                            @else
                                            <small class="d-block mt-1 text-white-50" style="font-size: 11px;">Sin fecha límite</small>
                                            @endif
                                        </th>
                                        @endforeach
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @switch($estado)
                                            @case(0)
                                            <button type="button" class="estadoBtn asignada" title="Revisión inactiva" style="cursor: not-allowed; opacity: 0.6;">
                                                <i class="bi bi-pause-circle-fill"></i>
                                            </button>
                                            @break

                                            @case(1)
                                            <button type="button" class="estadoBtn vacio" title="Sin evidencia cargada" style="cursor: not-allowed; opacity: 0.6;">
                                                <i class="bi bi-dash-circle-fill"></i>
                                            </button>
                                            @break

                                            @case(2)
                                            {{-- Aprobada: Redirecciona al SHOW --}}
                                            <a href="{{ url('/evidencias/ver-detalle/' . $materia->id . '?revision_id=' . $revision->id) }}" class="d-inline-block" title="Evidencia Aprobada. Click para ver detalle completo.">
                                            ...
                                            <a href="{{ url('/evidencias/edit/' . $evidenciaActual->id) }}" class="d-inline-block" title="Evidencia Pendiente. Click para gestionar u optimizar.">
                                            ...
                                            <a href="{{ url('/evidencias/edit/' . $evidenciaActual->id) }}" class="d-inline-block" title="Evidencia Rechazada. Click para corregir u observar anomalías.">
