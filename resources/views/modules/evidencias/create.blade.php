            ...
            <div class="card p-4 shadow-lg border-0" style="border-radius: 18px;">
                @if ($errors->any())
                    <div class="alert alert-danger alert-dismissible fade show rounded-3 mb-4" role="alert">
                        <h6 class="fw-bold"><i class="bi bi-exclamation-triangle-fill me-2"></i>Por favor corrige los
                ...
                <form action="{{ route('evidencias.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row g-3 mb-4" id="contenedor_tarjetas_unidades">
                        <div class="col-12">
                            <span class="text-muted small">Selecciona una materia y revisión para cargar las unidades
                                disponibles.</span>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="card h-100 border border-light-subtle rounded-3 shadow-sm p-4 bg-white">
                                ...
                                <input type="file" name="analisis_diagnostico"
                                    class="form-control form-control-lg fs-6" required>
                            </div>
                        </div>
            ...
            `;
                ...
                <div class="rac-row mb-2">
                    ...
                    <input type="file"
                           name="rac[${unidad}]"
                           id="rac_file_${unidad}"
                           class="form-control form-control-sm fs-6 rac-file"
                           required>
        ...
        function renderizarDropzoneUnidad(unidad) {
            ...
            if (files.length === 0) {
                lista.innerHTML =
                    ...
                    Ningún archivo seleccionado para la Unidad ${unidad}
                </span>`;
                return;
            }
