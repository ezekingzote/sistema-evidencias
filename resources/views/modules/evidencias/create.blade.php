                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-custom shadow-sm">
                                            ...
                                            <select name="materia_id" class="form-control border-start-0" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="section-box">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    <input type="file" name="evi_a" class="form-control"
                                                        accept=".pdf" required>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    <input type="file" name="evi_b" class="form-control"
                                                        accept=".pdf" required>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    <input type="file" name="evi_c" class="form-control"
                                                        accept=".pdf" required>
