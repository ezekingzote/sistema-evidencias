            ...
            <div class="card shadow-sm border-0" style="border-radius: 16px;">
                ...
                <div class="card-body p-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <a href="" class="btn btn-outline-primary btn-sm me-1"><i class="fa-regular fa-eye"></i> Revisar</a>
                                    </td>
                                </tr>
                    ...
                    <div class="text-end mt-4 border-top pt-4">
                        <a href="{{ route('revisiones') }}" class="btn btn-outline-info px-4 shadow-sm">
